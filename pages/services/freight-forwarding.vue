...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Экспедирование грузов по РБ, РФ и странам СНГ, +375292837757' },
    { name: 'keywords', content: 'Экспедиторские услуги для грузоперевозок между Россией и Беларусью' }
  ]
});
</script>
