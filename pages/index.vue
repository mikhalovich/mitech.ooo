...
useHead({
  title:
    'Международные грузоперевозки и экспедирование грузов от компании MiTech',
  meta: [
    {
      name: 'description',
      content:
        'Грузовые перевозки РБ, РФ, СНГ. Полный комплекс услуг. Индивидуальный подход. Подробности по тел. +375292837757'
    },
    {
      name: 'keywords',
      content:
